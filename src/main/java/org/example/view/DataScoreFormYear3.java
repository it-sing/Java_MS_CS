 ...
 * @author The User
 */
public class DataScoreFormYear3 extends javax.swing.JFrame {

    /**
     * Creates new form DataScore1
     */
    public DataScoreFormYear3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataScoreFormYear3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataScoreFormYear3().setVisible(true);
            }
        });
    }
