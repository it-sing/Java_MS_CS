...
public class ReportYear3View extends JFrame {
    ...
    private void initializeUI() {
        ...
        btnExcel.addActionListener(e -> ConvertFile.exportToExcel(ReportYear3View.this, tableModel, "Year1"));
        ...
        tableModel.setColumnIdentifiers(new Object[]{ "Std Code", "Name", "Sex", ".Net", "Java", "Network", "ISAD", "Statistics", "Semester", "AVG"});
