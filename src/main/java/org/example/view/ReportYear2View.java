...
public class ReportYear2View extends JFrame {
    ...
    private void initializeUI() {
        ...
        btnExcel.addActionListener(e -> ConvertFile.exportToExcel(ReportYear2View.this, tableModel, "Report_Year1"));
        ...
        btnPdf.addActionListener(e -> ConvertFile.exportToPDF(ReportYear2View.this, tableModel, "Report_Year2"));

        // Create the table model and table
        tableModel = new DefaultTableModel();
        tableModel.setColumnIdentifiers(new Object[]{"Student Code", "Name", "Sex", "Communication", "Data Structure", "English", "Cpp", "Architecture", "Database", "Semester", "GPA"});
