 ...
 * @author The User
 */
public class DataScoreFormYear4 extends javax.swing.JFrame {

    /**
     * Creates new form DataScore1
     */
    public DataScoreFormYear4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataScoreFormYear4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataScoreFormYear4().setVisible(true);
            }
        });
    }
