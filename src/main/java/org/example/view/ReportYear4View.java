...
public class ReportYear4View extends JFrame {
    ...
    private void initializeUI() {
        ...
        btnExcel.addActionListener(e -> ConvertFile.exportToExcel(ReportYear4View.this, tableModel, "Year2"));
        ...
        tableModel.setColumnIdentifiers(new Object[]{"ID", "Code", "Name", "Sex", "OOAD", "Web", "Linux", "MIS", "SE", "Semester"});
